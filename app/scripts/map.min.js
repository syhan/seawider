...
!function(global) {
    if (!global.AMap) throw new Error("è¯·å‰ç½®å¼•å…¥é«˜å¾·åœ°å›¾apiï¼Œå‚è§http://lbs.amap.com/api/javascript-api/gettingstarted/");
}(window);
...
!function(ns, window) {
    ...
    ns.checkDomLibrary = function($, opts) {
        ...
        return !(libInfo.isJQuery && ns.versionCompare(libInfo.version, opts.minJQueryVersion) < 0) || "jQueryå½“å‰ç‰ˆæœ¬(" + libInfo.version + ")è¿‡ä½Žï¼Œè¯·æ›´æ–°åˆ° " + opts.minJQueryVersion + " æˆ–ä»¥ä¸Šç‰ˆæœ¬ï¼";
    };
